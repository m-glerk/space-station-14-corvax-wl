...
severe-pain-applied = Ваше тело немеет.
blackout-pain-applied = Вы вот-вот потеряете сознание.
fracture-applied = Что-то сломалось внутри вас.
arterial-bleeding-applied = По вашему телу разливается неестественное тепло.
...
critical-brain-damage-applied = Вы чувствуете себя отрезанным от мира.
brain-oxygen-depleted = Вы с трудом управляете вашими конечностями.
severe-brain-damage-applied = Вы с трудом управляете вашим телом.

iv-bag-none-inserted = На стойке нет пакета.
...
backfired-gun = Ваши руки трясутся, и вы попадаете по себе!
backfired-hypospray = Ваши руки трясутся, и вы случайно вводите гипоспрей себе.
...
zombification-120-message-2 = Вы чувствуете будто вашу кожу пронзают иглы.
