...
reagent-name-osseous = костный реагент
...
reagent-desc-convermol = Быстродействующее лекарство, которое заставляет организм дышать. Повреждет мышцы, но эффективно восстанавливет доступ к воздуху.

reagent-name-salicylic-acid = салициловая кислота
reagent-desc-salicylic-acid = Соединение с ужасным запахом, которое обеспечивает обезболивание и заживление при тяжёлых физических травмах. Чрезвычайно высокие дозы могут вызвать экстримальную регенерацию костей.

reagent-name-oxandrolone = оксандролон
reagent-desc-oxandrolone = Мощное средство от ожогов, которое обеспечивает обезболивание и заживление при тяжёлых ожоговых травмах. Чрезвычайно высокие дозы могут вызвать экстримальную регенерацию кожи.
